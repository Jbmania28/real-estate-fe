        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse flex-grow-1 text-right" id="myNavbar">
            <ul class="navbar-nav ms-auto">
              ...
              <li className="nav-item">
                <Link className="nav-link" onClick={handleShow}>Log out</Link>
                ...
                <Modal show={show} onHide={handleClose}>
                  ...
                  <Modal.Footer>
                    ...
                    <Button variant="primary"  style={{"padding":"5px 20px 5px","backgroundColor":"rgb(4, 4, 229)"}} onClick={handleLogout}>
                      confirm
                    </Button>
                  </Modal.Footer>
                </Modal>
